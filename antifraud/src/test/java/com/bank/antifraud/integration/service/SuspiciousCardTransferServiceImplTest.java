...
class SuspiciousCardTransferServiceImplTest extends TestContainer {
    @Autowired
    SuspiciousCardTransferService service;
    private final SuspiciousCardTransferDto dto
            = new SuspiciousCardTransferDto(null, 1L, false
    ...
    void saveNegativeTest() {
        assertThrows(DataIntegrityViolationException.class, () -> service.save(new SuspiciousCardTransferDto()));
    }

    @Test
    @DisplayName("Поиск по id, позитивный сценарий")
    void findByIdPositiveTest() {
        SuspiciousCardTransferDto byId = service.findById(4L);
    ...
    void findByIdNegativeTest() {
        ...
        assertEquals("SuspiciousCardTransfer по данному id не существует"
    ...
    void updatePositiveTest() {
        SuspiciousCardTransferDto update = service.update(4L, dto);
    ...
    void findAllByIdPositiveTest() {
        List<SuspiciousCardTransferDto> allById = service.findAllById(Arrays.asList(4L, 2L));

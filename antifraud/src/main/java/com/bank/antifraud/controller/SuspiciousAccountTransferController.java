...
public class SuspiciousAccountTransferController {
     ...
     */
    @Operation(summary = "Получение информации о подозрительном переводе по номеру счета по id")
    @GetMapping("/{id}")
     ...
     */
    @Operation(summary = "Получение информации о нескольким подозрительных переводах по номеру счета по id")
    @GetMapping
     ...
     * @return {@link ResponseEntity} {@link SuspiciousAccountTransferDto}
     */
    @Operation(summary = "Создание подозрительного перевода по номеру счета по id")
    @PostMapping("/create")
     ...
     * @return {@link ResponseEntity} {@link SuspiciousAccountTransferDto}
     */
    @Operation(summary = "Обновление информации о подозрительном переводе по номеру счета по id")
    @PutMapping("/{id}")

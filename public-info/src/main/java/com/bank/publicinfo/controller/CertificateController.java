...
public class CertificateController {
     ...
     */
    @GetMapping("/{id}")
    @Operation(summary = "Получение информации о сертификате по id")
     ...
     */
    @GetMapping("/read/all")
    @Operation(summary = "Получение информации о нескольких сертификатах по id")
     ...
     */
    @PostMapping("/create")
    @Operation(summary = "Создание нового сертификата")
    ...
    @Operation(summary = "Обновление информации о сертификате по id")

...
public class BankDetailsController {
     ...
     */
    @GetMapping("/{id}")
    @Operation(summary = "Получение информации о банковских реквизитах по id")
     ...
     */
    @GetMapping("/read/all")
    @Operation(summary = "Получение информации о нескольких банковских реквизитах по id")
    ...
    @Operation(summary = "Обновление информации о банковских реквизитах по id")

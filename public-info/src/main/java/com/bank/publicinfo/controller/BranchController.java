...
public class BranchController {
     ...
     */
    @GetMapping("/{id}")
    @Operation(summary = "Получение информации об отделении банка по id")
     ...
     */
    @GetMapping("/read/all")
    @Operation(summary = "Получение информации о нескольких отделениях банка по id")
     ...
     */
    @PostMapping("/create")
    @Operation(summary = "Создание нового отделения банка")
    ...
    @Operation(summary = "Обновление информации об отделении о банке по id")

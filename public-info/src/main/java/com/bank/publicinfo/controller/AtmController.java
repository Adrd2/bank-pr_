...
public class AtmController {
     ...
     */
    @GetMapping("/{id}")
    @Operation(summary = "Получение информации о банкомате по id")
     ...
     */
    @GetMapping("/read/all")
    @Operation(summary = "Получение информации о нескольких банкоматах по id")
     ...
     */
    @PostMapping("/create")
    @Operation(summary = "Создание нового банкомата")
    ...
    @Operation(summary = "Обновление информации о банкомате по id")

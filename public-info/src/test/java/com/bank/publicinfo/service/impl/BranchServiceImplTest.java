...
@SpringJUnitConfig(initializers = ConfigDataApplicationContextInitializer.class, classes = {
        BranchServiceImpl.class, BranchMapperImpl.class, EntityNotFoundSupplier.class})
class BranchServiceImplTest {
    ...
    private BranchDto actual;
    private BranchEntity entity;
    private BranchEntity entity2;
    List<BranchEntity> entityList;

    @BeforeEach
    void setUp() {
        entityList = new ArrayList<>();
        dto = new BranchDto(1L, "address", 89998889988L, "City",
                LocalTime.MIN, LocalTime.MAX);
        entity = new BranchEntity(1L, "address", 89998889988L, "City",
                LocalTime.MIN, LocalTime.MAX);
        entity2 = new BranchEntity(2L, "address", 89998889988L, "City",
                LocalTime.MIN, LocalTime.MAX);
    }

...
class AccountDetailsMapperTest {
    ...
    void toDtoListPositiveTest() {
        ...
        AccountDetailsEntity entity1 = new AccountDetailsEntity(1L, 123L, 456L, 789L, BigDecimal.valueOf(1000), false, 1L);
        AccountDetailsEntity entity2 = new AccountDetailsEntity(2L, 234L, 567L, 890L, BigDecimal.valueOf(2000), true, 2L);
        entityList.add(entity1);
        entityList.add(entity2);

        AccountDetailsDto dto1 = new AccountDetailsDto(1L, 123L, 456L, 789L, BigDecimal.valueOf(1000), false, 1L);
        AccountDetailsDto dto2 = new AccountDetailsDto(2L, 234L, 567L, 890L, BigDecimal.valueOf(2000), true, 2L);
    ...
    @Test
    @DisplayName("маппинг в списко dto, на вход подан null")

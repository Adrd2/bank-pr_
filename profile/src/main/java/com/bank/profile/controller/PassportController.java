...
@Tag(name = "Контроллер для паспортов")
public class PassportController {
    ...
    @Operation(summary = "Обновление информации о паспорте по id")
     ...
     */
    @GetMapping("read/all")
    @Operation(summary = "Получение информации о нескольких паспортах по id")

...
@Tag(name = "Контроллер для регистраций")
public class RegistrationController {
     ...
     */
    @GetMapping("/read/{id}")
    @Operation(summary = "Получение информации о регистрации по id")
     ...
     */
    @PostMapping("/create")
    @Operation(summary = "Создание регистрации")
    public ResponseEntity<RegistrationDto> create(@RequestBody @Valid RegistrationDto registration) {
    ...
    @Operation(summary = "Обновление информации о регистрации по id")
     ...
     */
    @GetMapping("read/all")
    @Operation(summary = "Получение информации о нескольких регистрациях по id")
